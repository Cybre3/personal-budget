...
// import {
//   FIRST_HALF_MONTH_BILL_TOTAL,
//   SECOND_HALF_MONTH_BILL_TOTAL,
// } from "./billInfo";
  ...
  render() {
    ...
    return (
      <div className="bg-neutral-700 text-white w-1/2 mx-auto py-4 rounded-md relative">
        <h1 className="text-center text-xl uppercase font-bold my-4">
          Name Budget{" "}
          ...
          <div className="bg-slate-700 p-2 rounded-md space-y-1 border border-white">
            <div className="flex place-content-evenly">
              <input
                name="Gas"
                placeholder="Gas"
                className="border-0 border-transparent outline-0 placeholder-white bg-transparent w-fit text-white px-2"
              />{" "}
              {this.renderInput("gas", "")}
            </div>
            <div className="flex">
              <input
                name="House"
                placeholder="House"
                className="border-0 border-transparent outline-0 placeholder-white bg-transparent"
              />{" "}
              {this.renderInput("house", "")}
            </div>
            <div className="flex">
              <input
                name="Food"
            ...
            <div className="flex">
              <input
                ...
                className="border-0 border-transparent outline-0 placeholder-white bg-transparent"
              />{" "}
              {this.renderInput("cash", "")}
            </div>

            <button className="bg-gray-400 p-1 px-3 text-black border-black border rounded">
              add category
            </button>
          </div>
